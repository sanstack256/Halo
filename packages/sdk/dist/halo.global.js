...
var HaloBundle = (() => {
  ...
  // ../replay/dist/index.js
  var dist_exports = {};
  __export(dist_exports, {
    HaloFeedbackWidget: () => HaloFeedbackWidget,
  ...
  function sanitizeUrl2(urlStr) {
    ...
    try {
      ...
      for (const key of keys) {
        ...
        if (SENSITIVE_QUERY_PARAMS2.some((p) => p.toLowerCase() === lower) || lower.includes("token") || lower.includes("secret") || lower.includes("auth") || lower.includes("key") || lower.includes("pass")) {
  ...
  var __defProp2, __defNormalProp2, __publicField2, _a, __defProp$1, __defNormalProp$1, __publicField$1, NodeType$3, testableAccessors$1, testableMethods$1, untaintedBasePrototype$1, untaintedBaseIframeCleanup$1, isAngularZonePresent$1, untaintedAccessorCache$1, untaintedMethodCache$1, nowTimestamp$1, index$1, Mirror, ORIGINAL_ATTRIBUTE_NAME, URL_IN_CSS_REF, URL_PROTOCOL_MATCH, URL_WWW_MATCH, DATA_URI, _id, tagNameRegex, IGNORED_NODE, canvasService, canvasCtx, SRCSET_NOT_SPACES, SRCSET_COMMAS_OR_SPACES, cachedDocument, MEDIA_SELECTOR, MEDIA_SELECTOR_GLOBAL, picocolors_browser$1, hasRequiredPicocolors_browser$1, __viteBrowserExternal$2, __viteBrowserExternal$1$1, require$$2$1, cssSyntaxError$1, hasRequiredCssSyntaxError$1, symbols$1, hasRequiredSymbols$1, stringifier$1, hasRequiredStringifier$1, stringify_1$1, hasRequiredStringify$1, node$1, hasRequiredNode$1, declaration$1, hasRequiredDeclaration$1, nonSecure$1, hasRequiredNonSecure$1, previousMap$1, hasRequiredPreviousMap$1, input$1, hasRequiredInput$1, mapGenerator$1, hasRequiredMapGenerator$1, comment$1, hasRequiredComment$1, container$1, hasRequiredContainer$1, document$1$1, hasRequiredDocument$1, warnOnce$1, hasRequiredWarnOnce$1, warning$1, hasRequiredWarning$1, result$1, hasRequiredResult$1, tokenize$1, hasRequiredTokenize$1, atRule$1, hasRequiredAtRule$1, root$1, hasRequiredRoot$1, list_1$1, hasRequiredList$1, rule$1, hasRequiredRule$1, parser$1, hasRequiredParser$1, parse_1$1, hasRequiredParse$1, lazyResult$1, hasRequiredLazyResult$1, noWorkResult$1, hasRequiredNoWorkResult$1, processor$1, hasRequiredProcessor$1, fromJSON_1$1, hasRequiredFromJSON$1, postcss_1$1, hasRequiredPostcss$1, postcssExports$1, postcss$1, __defProp22, __defNormalProp22, __publicField22, picocolors_browser, hasRequiredPicocolors_browser, __viteBrowserExternal, __viteBrowserExternal$1, require$$2, cssSyntaxError, hasRequiredCssSyntaxError, symbols, hasRequiredSymbols, stringifier, hasRequiredStringifier, stringify_1, hasRequiredStringify, node, hasRequiredNode, declaration, hasRequiredDeclaration, nonSecure, hasRequiredNonSecure, previousMap, hasRequiredPreviousMap, input, hasRequiredInput, mapGenerator, hasRequiredMapGenerator, comment, hasRequiredComment, container, hasRequiredContainer, document$1, hasRequiredDocument, warnOnce, hasRequiredWarnOnce, warning, hasRequiredWarning, result, hasRequiredResult, tokenize, hasRequiredTokenize, atRule, hasRequiredAtRule, root, hasRequiredRoot, list_1, hasRequiredList, rule, hasRequiredRule, parser, hasRequiredParser, parse_1, hasRequiredParse, lazyResult, hasRequiredLazyResult, noWorkResult, hasRequiredNoWorkResult, processor, hasRequiredProcessor, fromJSON_1, hasRequiredFromJSON, postcss_1, hasRequiredPostcss, postcssExports, postcss, BaseRRNode, testableAccessors, testableMethods, untaintedBasePrototype, untaintedBaseIframeCleanup, isAngularZonePresent, untaintedAccessorCache, untaintedMethodCache, nowTimestamp, index, DEPARTED_MIRROR_ACCESS_WARNING, _mirror, StyleSheetMirror, EventType, IncrementalSource, MouseInteractions, PointerTypes, CanvasContext, MediaInteractions, NodeType, DoubleLinkedList, moveKey, MutationBuffer, errorHandler, callbackWrapper, mutationBuffers, INPUT_TAGS, lastInputValueMap, CrossOriginIframeMirror, IframeManager, ShadowDomManager, chars, lookup, i$1, encode, canvasVarMap, saveWebGLVar, serializeArgs, isInstanceOfWebGLObject, jsContent, blob, CanvasManager, StylesheetManager, ProcessedNodeManager, wrappedEmit, takeFullSnapshot$1, canvasManager, recording, mirror, n, SKIP_TIME_INTERVAL, addCustomEvent, freezePage, takeFullSnapshot, DEFAULT_MASK_SELECTORS, DEFAULT_BLOCK_SELECTORS, DEFAULT_IGNORE_SELECTORS, SENSITIVE_QUERY_PARAMS2, ReplayRingBuffer, ReplayUploader, HaloFeedbackWidget, HaloReplay;
  var init_dist = __esm({
    "../replay/dist/index.js"() {
      "use strict";
      ...
      symbols$1 = {};
      postcssExports$1 = requirePostcss$1();
      postcss$1 = /* @__PURE__ */ getDefaultExportFromCjs$1(postcssExports$1);
      postcss$1.stringify;
      postcss$1.fromJSON;
      postcss$1.plugin;
      postcss$1.parse;
      ...
      postcss = /* @__PURE__ */ getDefaultExportFromCjs(postcssExports);
      postcss.stringify;
      postcss.fromJSON;
      postcss.plugin;
      postcss.parse;
      ...
      blob = typeof self !== "undefined" && self.Blob && new Blob([jsContent], { type: "text/javascript;charset=utf-8" });
      CanvasManager = class {
        constructor(options) {
        ...
        async flush(isFinal = false, extraMeta) {
          ...
          const payload = {
            ...
            meta: {
              ...
              url: typeof window !== "undefined" ? sanitizeUrl2(window.location.href) : void 0,
      ...
      HaloReplay = class {
        ...
        handleEvent(event) {
          ...
          if (event.type === 4 && event.data?.href) {
            event.data.href = sanitizeUrl2(event.data.href);
          }
          if (event.type === 3) {
        ...
        setupNavigationInstrumentation() {
          ...
          const notifyNavigation = (toUrl, type) => {
            const sanitized = sanitizeUrl2(toUrl);
            const fromSanitized = sanitizeUrl2(this.currentUrl);
        ...
        setupNetworkInstrumentation() {
          ...
          window.fetch = async (input2, init2) => {
            ...
            if (urlStr.includes("/api/ingest/")) {
              return this.originalFetch(input2, init2);
            }
            let traceId;
            let requestId;
            if (init2?.headers) {
            ...
            try {
              const response = await this.originalFetch(input2, init2);
              const durationMs = Date.now() - start;
              this.recordCustomEvent("halo:request", {
                method,
                url: sanitizeUrl2(urlStr),
              ...
              const durationMs = Date.now() - start;
              const isAborted = err?.name === "AbortError" || Boolean(init2?.signal?.aborted);
              this.recordCustomEvent("halo:request", {
                method,
                url: sanitizeUrl2(urlStr),
                status: 0,
  ...
  __export(browser_bundle_exports, {
    ...
    default: () => browser_bundle_default,
  ...
  var TraceContextManager = class {
    ...
    extractHeaders(headers) {
      const get = (key) => {
        ...
        return record2[key] || record2[key.toLowerCase()] || null;
      };
  ...
  function sanitizeHeaders(headers, allowlist) {
    ...
    for (const [k, v] of entries) {
      ...
      result2[k] = String(v).replace(BEARER_TOKEN_REGEX, "Bearer [REDACTED]");
    }
    return result2;
  }
  ...
  var SamplingEngine = class {
    constructor(options) {
      __publicField(this, "sessionRate");
      __publicField(this, "traceRate");
  ...
  var EnvelopeBuilder = class {
    constructor(sdkName = "@halo-trace/sdk", sdkVersion = "1.0.0") {
      __publicField(this, "sdkName");
      __publicField(this, "sdkVersion");
      __publicField(this, "runtimeInfo");
  ...
  var CoreClient = class {
    constructor(options, sdkName = "@halo-trace/sdk", sdkVersion = "1.0.0") {
      ...
      __publicField(this, "envelopeBuilder");
  ...
  function registerErrorInstrumentation(client, onFatalError) {
    ...
    return () => {
      window.removeEventListener("error", errorHandler2, true);
  ...
  function registerHttpInstrumentation(client, options = {}) {
    ...
    if (typeof window.fetch === "function") {
      ...
      window.fetch = async function(input2, init2) {
        const rawUrl = typeof input2 === "string" ? input2 : input2 instanceof URL ? input2.toString() : input2.url;
        if (shouldIgnore(rawUrl)) {
          return originalFetch.call(this, input2, init2);
        }
        const method = (init2?.method || (typeof input2 === "object" && "method" in input2 ? input2.method : "GET")).toUpperCase();
        ...
        const headers = new Headers(init2?.headers || (typeof input2 === "object" && "headers" in input2 ? input2.headers : {}));
        ...
        try {
          const response = await originalFetch.call(this, input2, {
            ...init2,
            headers
          });
  ...
  var ReplayBridge = class {
    constructor(client, config) {
      __publicField(this, "replayInstance", null);
    ...
    async initialize(endpoint, apiKey) {
      ...
      try {
        ...
        if (typeof window !== "undefined" && window.HaloReplayBundle?.HaloReplay) {
          ...
          try {
            ReplayModule = await Promise.resolve().then(() => (init_dist(), dist_exports));
          } catch {
            return;
          }
        }
  ...
  var BrowserClient = class extends CoreClient {
    constructor(options) {
      ...
      __publicField(this, "replayBridge");
  ...
  var Halo = class _Halo {
    constructor(options) {
      ...
      window.__HALO_INSTANCE__ = this;
    }
    static init(options) {
      if (window.__HALO_INSTANCE__) {
        window.__HALO_INSTANCE__.close();
      }
      const inst = new _Halo(options);
      return inst;
    }
    static getClient() {
      return window.__HALO_INSTANCE__?.client || null;
    }
    getClientInstance() {
      return this.client;
    }
    ...
    get feedback() {
      return {
        open: (opts) => this.client.openFeedbackModal(opts)
      };
    }
    openFeedbackModal(options) {
    ...
    static captureException(error, additional) {
      return window.__HALO_INSTANCE__?.captureException(error, additional);
    }
    static captureMessage(message, severity, additional) {
      return window.__HALO_INSTANCE__?.captureMessage(message, severity, additional);
    }
    static addBreadcrumb(breadcrumb) {
      window.__HALO_INSTANCE__?.addBreadcrumb(breadcrumb);
    }
    static setUser(user) {
      window.__HALO_INSTANCE__?.setUser(user);
    }
    static clearUser() {
      window.__HALO_INSTANCE__?.clearUser();
    }
    static setTag(key, value) {
      window.__HALO_INSTANCE__?.setTag(key, value);
    }
    static setContext(name, data) {
      window.__HALO_INSTANCE__?.setContext(name, data);
    }
    static getSessionId() {
      return window.__HALO_INSTANCE__?.getSessionId();
    }
    static getTraceContext() {
      return window.__HALO_INSTANCE__?.getTraceContext();
    }
    static async flush() {
      await window.__HALO_INSTANCE__?.flush();
    }
    static close() {
      window.__HALO_INSTANCE__?.close();
    }
  ...
  var browser_bundle_default = Halo;
...
rrweb/dist/rrweb.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=halo.global.js.map