...
Total : 340 files,  59317 codes, 12389 comments, 9737 blanks, all 81443 lines
...
| [apps/dashboard/package.json](/apps/dashboard/package.json) | JSON | 49 | 0 | 1 | 50 |
...
| [apps/dashboard/src/actions/issue.ts](/apps/dashboard/src/actions/issue.ts) | TypeScript | 613 | 187 | 99 | 899 |
...
| [apps/dashboard/src/actions/project.ts](/apps/dashboard/src/actions/project.ts) | TypeScript | 145 | 0 | 35 | 180 |
...
| [apps/dashboard/src/app/(auth)/layout.tsx](/apps/dashboard/src/app/(auth)/layout.tsx) | TypeScript JSX | 13 | 0 | 3 | 16 |
...
| [apps/dashboard/src/app/(dashboard)/layout.tsx](/apps/dashboard/src/app/(dashboard)/layout.tsx) | TypeScript JSX | 29 | 2 | 8 | 39 |
...
| [apps/dashboard/src/app/(dashboard)/projects/\[id\]/investigations/new/page.tsx](/apps/dashboard/src/app/(dashboard)/projects/%5Bid%5D/investigations/new/page.tsx) | TypeScript JSX | 585 | 29 | 49 | 663 |
...
| [apps/dashboard/src/app/(dashboard)/projects/\[id\]/settings/page.tsx](/apps/dashboard/src/app/(dashboard)/projects/%5Bid%5D/settings/page.tsx) | TypeScript JSX | 12 | 0 | 1 | 13 |
| [apps/dashboard/src/app/(dashboard)/projects/page.tsx](/apps/dashboard/src/app/(dashboard)/projects/page.tsx) | TypeScript JSX | 46 | 1 | 28 | 75 |
...
| [apps/dashboard/src/app/api/ingest/events/route.ts](/apps/dashboard/src/app/api/ingest/events/route.ts) | TypeScript | 62 | 0 | 18 | 80 |
...
| [apps/dashboard/src/components/overview/sidebar.tsx](/apps/dashboard/src/components/overview/sidebar.tsx) | TypeScript JSX | 431 | 2 | 30 | 463 |
...
| [apps/dashboard/src/components/projects/create-project-dialog.tsx](/apps/dashboard/src/components/projects/create-project-dialog.tsx) | TypeScript JSX | 109 | 0 | 12 | 121 |
...
| [apps/dashboard/src/components/replay/replay-player-client.tsx](/apps/dashboard/src/components/replay/replay-player-client.tsx) | TypeScript JSX | 500 | 24 | 64 | 588 |
...
| [apps/dashboard/src/components/ui/relative-time.tsx](/apps/dashboard/src/components/ui/relative-time.tsx) | TypeScript JSX | 13 | 0 | 2 | 15 |
...
| [apps/dashboard/src/generated/prisma/internal/prismaNamespace.ts](/apps/dashboard/src/generated/prisma/internal/prismaNamespace.ts) | TypeScript | 1,649 | 297 | 229 | 2,175 |
| [apps/dashboard/src/generated/prisma/internal/prismaNamespaceBrowser.ts](/apps/dashboard/src/generated/prisma/internal/prismaNamespaceBrowser.ts) | TypeScript | 263 | 33 | 76 | 372 |
...
| [apps/dashboard/src/generated/prisma/models/Project.ts](/apps/dashboard/src/generated/prisma/models/Project.ts) | TypeScript | 1,560 | 757 | 187 | 2,504 |
...
| [apps/dashboard/src/lib/auth.ts](/apps/dashboard/src/lib/auth.ts) | TypeScript | 102 | 0 | 13 | 115 |
...
| [apps/dashboard/src/lib/investigation/evidence.ts](/apps/dashboard/src/lib/investigation/evidence.ts) | TypeScript | 282 | 40 | 84 | 406 |
| [apps/dashboard/src/lib/investigation/interpreter.ts](/apps/dashboard/src/lib/investigation/interpreter.ts) | TypeScript | 849 | 73 | 100 | 1,022 |
...
| [apps/dashboard/src/lib/prisma.ts](/apps/dashboard/src/lib/prisma.ts) | TypeScript | 16 | 1 | 5 | 22 |
| [apps/dashboard/src/lib/session.ts](/apps/dashboard/src/lib/session.ts) | TypeScript | 7 | 0 | 1 | 8 |
...
| [packages/investigation-engine/src/engine.ts](/packages/investigation-engine/src/engine.ts) | TypeScript | 198 | 0 | 39 | 237 |
...
| [packages/investigation-engine/src/hypotheses/cascading-failure.ts](/packages/investigation-engine/src/hypotheses/cascading-failure.ts) | TypeScript | 67 | 3 | 12 | 82 |
| [packages/investigation-engine/src/hypotheses/database-failure.ts](/packages/investigation-engine/src/hypotheses/database-failure.ts) | TypeScript | 90 | 1 | 8 | 99 |
...
| [packages/investigation-engine/src/hypotheses/network-protocol.ts](/packages/investigation-engine/src/hypotheses/network-protocol.ts) | TypeScript | 118 | 0 | 8 | 126 |
...
| [packages/investigation-engine/src/hypotheses/runtime-exception.ts](/packages/investigation-engine/src/hypotheses/runtime-exception.ts) | TypeScript | 146 | 1 | 9 | 156 |
...
| [packages/investigation-engine/src/index.ts](/packages/investigation-engine/src/index.ts) | TypeScript | 18 | 0 | 1 | 19 |
...
| [packages/investigation-engine/src/pipeline/correlate.ts](/packages/investigation-engine/src/pipeline/correlate.ts) | TypeScript | 759 | 0 | 114 | 873 |
...
| [packages/investigation-engine/src/pipeline/rank.ts](/packages/investigation-engine/src/pipeline/rank.ts) | TypeScript | 308 | 160 | 50 | 518 |
| [packages/investigation-engine/src/pipeline/recommend.ts](/packages/investigation-engine/src/pipeline/recommend.ts) | TypeScript | 654 | 0 | 117 | 771 |
...
| [packages/investigation-engine/src/rules/pre-existing-error.ts](/packages/investigation-engine/src/rules/pre-existing-error.ts) | TypeScript | 55 | 0 | 8 | 63 |
...
| [packages/investigation-engine/src/types/graph.ts](/packages/investigation-engine/src/types/graph.ts) | TypeScript | 34 | 0 | 10 | 44 |
| [packages/investigation-engine/src/types/hypothesis.ts](/packages/investigation-engine/src/types/hypothesis.ts) | TypeScript | 27 | 0 | 16 | 43 |
| [packages/investigation-engine/src/types/impact.ts](/packages/investigation-engine/src/types/impact.ts) | TypeScript | 11 | 0 | 4 | 15 |
| [packages/investigation-engine/src/types/investigation.ts](/packages/investigation-engine/src/types/investigation.ts) | TypeScript | 59 | 0 | 21 | 80 |
| [packages/investigation-engine/src/types/reason.ts](/packages/investigation-engine/src/types/reason.ts) | TypeScript | 13 | 0 | 7 | 20 |
| [packages/investigation-engine/src/types/recommendation.ts](/packages/investigation-engine/src/types/recommendation.ts) | TypeScript | 13 | 0 | 7 | 20 |
...
| [packages/sdk/src/halo.ts](/packages/sdk/src/halo.ts) | TypeScript | 307 | 17 | 104 | 428 |
...
| [packages/sdk/src/types.ts](/packages/sdk/src/types.ts) | TypeScript | 65 | 30 | 37 | 132 |
...
| [pnpm-lock.yaml](/pnpm-lock.yaml) | YAML | 6,441 | 0 | 1,655 | 8,096 |
