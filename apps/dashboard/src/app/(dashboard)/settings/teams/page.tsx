    ...
    return (
        <div className="space-y-8 pb-16">
            <div className="halo-page-header">
                <h1 className="halo-page-title">Teams</h1>
                <p className="halo-page-description">Organize members into teams for shared ownership and alert routing.</p>
            </div>
            ...
            <div className="halo-card p-12 flex flex-col items-center text-center gap-4">
                ...
                <p className="text-xs text-secondary max-w-sm leading-relaxed">Create and manage teams within your organization. Assign projects and set notification routing.</p>
            </div>
        </div>
    );
}
