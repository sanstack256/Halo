    ...
    return (
        <div className="space-y-8 pb-16">
            <div className="halo-page-header">
                <h1 className="halo-page-title">Repositories</h1>
            ...
            <div className="halo-card p-12 flex flex-col items-center text-center gap-4">
                ...
                <p className="text-xs text-secondary max-w-sm leading-relaxed">Connect GitHub, GitLab, or Bitbucket repositories. Halo will correlate commits to deployments and errors.</p>
            </div>
        </div>
    );
}
