...
export default async function RecentInvestigationsPage() {
    const data = await getOverviewData();

    return (
        <div className="space-y-8 pb-12">
            <div className="halo-page-header">
                <h1 className="halo-page-title">Recent Investigations</h1>
                <p className="halo-page-description">
                    History of recent automated root cause analysis sessions and verdicts.
                </p>
            </div>
            ...
            {data.activeIncidents.length === 0 ? (
                <div className="halo-empty-state">
                    ...
                    <h3 className="halo-empty-state-title">No recent investigations</h3>
                    <p className="halo-empty-state-description">
                        No recent investigation reports available. Run an investigation from the Issues page.
                    </p>
                </div>
            ) : (
