...
export default async function TeamInvestigationsPage() {
    const data = await getOverviewData();

    return (
        <div className="space-y-8 pb-12">
            <div className="halo-page-header">
                <h1 className="halo-page-title">Team Investigations</h1>
                <p className="halo-page-description">
                    Shared root cause investigations across your organization.
                </p>
            </div>
            ...
            {data.activeIncidents.length === 0 ? (
                <div className="halo-empty-state">
                    ...
                    <h3 className="halo-empty-state-title">No team investigations</h3>
                    <p className="halo-empty-state-description">
                        No team investigations in progress.
                    </p>
