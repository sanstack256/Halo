...
export default async function RecurringPage() {
    const issues = await getAllOrgIssues({ recurring: true });

    return (
        <div className="space-y-8 pb-12">
            <div className="halo-page-header">
                <h1 className="halo-page-title">Recurring Issues</h1>
                <p className="halo-page-description">
                    High-frequency issues with more than 10 occurrences.
                </p>
            </div>

            {issues.length === 0 ? (
                <div className="halo-empty-state">
                    <ListFilter className="halo-empty-state-icon" />
                    <h3 className="halo-empty-state-title">No recurring issues</h3>
                    <p className="halo-empty-state-description">No high-frequency issues recorded.</p>
                </div>
            ) : (
                <div className="halo-table">
                    <div className="halo-table-header grid-cols-[1fr_140px_100px_100px_140px_140px]">
                        ...
                        <div className="halo-table-col-label">Occurrences</div>
