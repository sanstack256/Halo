        ...
        <section id="section-fix-recommendation" className="halo-fix-container space-y-6 scroll-mt-24">
            ...
            <div className="halo-fix-header">
                <div className="space-y-1">
                    ...
                    <p className="text-xs text-secondary">
                        Engineering recommendation synthesized directly from verified investigation telemetry and contract analysis.
                    </p>
                </div>
            ...
            {!recommendation && !isGenerating && (
                <div className="py-10 px-6 rounded-xl bg-[#080b11] border border-dashed border-white/10 text-center space-y-4">
                    ...
                    <div className="space-y-1 max-w-md mx-auto">
                        <h3 className="text-sm font-bold text-white">Generate Engineering Fix</h3>
                        <p className="text-xs text-secondary leading-relaxed">
                            Have the AI engine analyze the captured error stack, request payload, replay timeline, and source contracts to formulate the exact minimal fix.
                        </p>
                    </div>
                    <div>
                        <button
            ...
            {isGenerating && (
                <div className="py-12 px-6 rounded-xl bg-[#080b11] border border-white/5 text-center space-y-3">
                    ...
                    <p className="text-xs font-mono text-zinc-300">
                        Analyzing investigation evidence & contracts...
                    </p>
            ...
            {recommendation && !isGenerating && (
                <div className="space-y-6">
                    {/* A. Recommended Fix (Direct Engineering Instruction) */}
                    <div className="p-5 rounded-xl bg-[#080b11] border border-accent/30 space-y-2 relative">
                        <span className="text-[10px] font-mono uppercase font-bold tracking-wider text-accent block">
                            Recommended Fix
                        </span>
                                        ...
                                        <div className="halo-fix-code-header">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="font-semibold text-white">
                                                    {change.filePath || "Suggested Modification"}
                                                </span>
                                                {change.startLine && (
                                        ...
                                        <div className="halo-fix-code-content space-y-3">
                                            ...
                                            {change.currentCode && (
                                                <div className="space-y-1">
                                                    <span className="text-[10px] uppercase font-bold text-zinc-500 block">
                                                        Existing Code (Current Repository)
                                                    </span>
                                                    <pre className="p-2.5 rounded bg-red-500/[0.04] border border-red-500/15 text-zinc-300 overflow-x-auto text-xs">
                                            ...
                                            {change.proposedCode && (
                                                <div className="space-y-1">
                                                    ...
                                                    <pre className="p-2.5 rounded bg-emerald-500/[0.06] border border-emerald-500/20 text-emerald-200 overflow-x-auto text-xs font-bold">
                    ...
                    {/* D. Also Check (Consistency Checks) */}
                    ...
                    {/* E. What to Verify (Validation Blueprint) */}
