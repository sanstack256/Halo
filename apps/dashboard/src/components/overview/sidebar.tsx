...
const primaryNavigation: PrimarySection[] = [
        ...
        sections: [
            {
                items: [
                    ...
                    { label: "Saved", href: "/investigate/saved", icon: Bookmark },
    ...
    },
    {
        ...
        sections: [
            {
                items: [
                    { label: "Triage", href: "/issues", icon: ShieldAlert },
                    { label: "Patterns", href: "/issues/patterns", icon: Blocks },
                    { label: "Impact", href: "/issues/impact", icon: Network },
                    { label: "Evolution", href: "/issues/evolution", icon: History },
                    { label: "Evidence Gaps", href: "/issues/evidence-gaps", icon: HelpCircle },
                    { label: "Resolution", href: "/issues/resolution", icon: CheckCircle2 },
                ],
            },
        ],
    },
    ...
    },
    {
        ...
        sections: [
            ...
            },
            {
                ...
                collapsible: true,
                items: [
                    { label: "Autofix", href: "/settings/autofix", icon: Wrench },
